...
function Navbar(){
    const [stuData,setStuData]=useState([
        ...
        {id:2,Name:"Ram",Age:24,ourse:"MERN", Batch:"oct"},
    ...
    return(
        ...
        <Routes>
        <Route path='/Student' element={<Store.Provider value={{data:stuData,dataFunc:setStuData}}>
            <Student/>
            </Store.Provider>
            }/>
            ...
            <Route path='/edit' element={<Store.Provider value={{data:stuData,dataFunc:setStuData}}>
            <EditStudent/>
            </Store.Provider>
            }
               />
